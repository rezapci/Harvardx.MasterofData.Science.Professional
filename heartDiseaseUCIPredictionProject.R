...
# Loading Dataset
zip.fileName <- '/Users/Reza Hashemi/Downloads/HarvardX_DataScience_Professional/HarvardX_PH125.9_CapstoneProject/capstoneProject2/heart-disease-uci-data.zip'
